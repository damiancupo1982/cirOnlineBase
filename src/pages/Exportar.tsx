...
import { Download, FileText, Users, DollarSign, Calendar, Settings, Cloud } from 'lucide-react';
...
export const Exportar: React.FC = () => {
  ...
  const handleGoogleSheetsSync = async () => {
    try {
      setExportando('google-sheets');
      await googleSheets.syncAllData();
      alert('¡Datos sincronizados exitosamente con Google Sheets!');
    } catch (error) {
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-4">
            ...
            {googleAuth.isAuthenticated() && googleSheets.hasSpreadsheet() && (
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-blue-50">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Sincronizar con Google Sheets</h3>
                    <p className="text-sm text-gray-600">
                      Actualiza todos los datos en tu spreadsheet de Google Drive
                    </p>
                ...
                <button
                  ...
                  disabled={exportando === 'google-sheets'}
                ...
                >
                  ...
                  {exportando === 'google-sheets' ? 'Sincronizando...' : 'Sincronizar'}
                </button>
              </div>
            )}
